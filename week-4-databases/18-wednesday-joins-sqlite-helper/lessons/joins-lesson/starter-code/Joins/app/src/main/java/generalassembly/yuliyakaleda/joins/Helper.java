...
public class Helper extends SQLiteOpenHelper {
  ...
  public String getFullInformation() {
    //TODO: add the code from the lesson.
      ...
      Cursor cursor = db.rawQuery(query, null);
      while(cursor.moveToNext()) {
          result = cursor.getString(cursor.getColumnIndex(DataEntryCompany.COLUMN_NAME)) + cursor.getString(cursor.getColumnIndex(DataEntryCompany.COLUMN_AGE)) + cursor.getString(cursor.getColumnIndex(DataEntryCompany.COLUMN_ADDRESS)) + cursor.getString(cursor.getColumnIndex(DataEntryCompany.COLUMN_SALARY)) +cursor.getString(cursor.getColumnIndex(DataEntryDepartment.COLUMN_DEPARTMENT));
      }
      cursor.close();
      return result;
  }
